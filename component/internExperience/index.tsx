...
import { IinternExperience } from './IinternExperience';
  ...
  return (
    <div className="mt-5">
      <EmptyRowCol>
        <Row className="pb-3">
          <Col>
            <h2 style={Style.blue}>INTERN & EXTRACURRICULAR ACTIVITY{totalPeriod()}</h2>
          </Col>
        </Row>
...
function getFormattingExperienceTotalDuration(payload: IinternExperience.Payload) {
