...
const introduce: IIntroduce.Payload = {
  ...
  contents: [
    '경력 만 4년차 개발자로 웹 서비스를 개발/배포/운영하였습니다. 주로 Java & Spring 기반의 웹 개발을 담당했으며 기존 레거시 프로젝트 운영과 리팩토링 경험이 많고, 항상 최신의 기술이 옳다고 여기지 않지만. 상황에 따라 적절한 새로운 기술을 도입하기 위해 노력하였습니다.',
